...
Je dois ajouter la partie publications

Mon frontend tourne en local sur http://localhost:4200.
Le code est ici: https://github.com/Projet-OVA/frontend
Tu pourras configurer le CORS pour autoriser http://localhost:4200 à appeler ton API.
Quand ton backend sera déployé, donne-moi l’URL de base (ex. https://api.tondomaine.com) pour que je la configure dans mon ApiService.